        ...
        <div className="pin-spacer product-slider mt-5">
          ...
          >
            <div className="row d-flex flex-nowrap py-70 pin-wrap">
              <div className="d-flex flex-wrap col-6 col-sm-6 col-md-2 process-item process-item--nobefore product__wrapper py-5 communicate">
              ...
              <div className="d-flex flex-wrap col-12 col-sm-6 col-md-2 process-item product__wrapper py-5 run">
                <div className="product-slide-inner-block">
